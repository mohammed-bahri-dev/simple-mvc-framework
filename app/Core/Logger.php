...
class Logger
{
    ...
    public static function customErrorMsg()
    {
        ...
        echo '<p>Une erreur est survenue et a été reportée.</p>';
        exit;
    }
    /**
    ...
    {
        // Quick Fix : Filter ldap_bind errors
        if (strpos($message, "ldap_bind()") !== false) {
            return 0;
        }
     ...
     */
    public static function newMessage(\Throwable $exception)
    {
